...
public interface ProfileRepository extends JpaRepository<Profile, Long> {
    ...
    @Query("SELECT p FROM Profile p JOIN FETCH p.member WHERE p.id = :profileId")
    Optional<Profile> findProfileWithUsernameByProfileId(@Param("profileId") Long profileId);
}
